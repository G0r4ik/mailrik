<template>
  <aside class="sidebar sidebar_dekstop">
    <button class="sidebar__write-message">
      ...
      <div class="sidebar__write-message-text">Написать письмо</div>
    </button>
    <div class="sidebar__burger" @click="showFullSidebar">
      ...
      <span class="sidebar__burger-text">Скрыть</span>
    </div>
    ...
    <ul class="sidebar__folders">
      ...
      >
        ...
        <span class="folders__item-text">Входящие</span>
      </li>
      <li
        class="folders__item"
        :class="{
      ...
      >
        ...
        <span class="folders__item-text">Важное</span>
      </li>
      <li
        class="folders__item"
        :class="{
      ...
      >
        ...
        <span class="folders__item-text">Отправленные</span>
      </li>
      <li
        class="folders__item"
        :class="{
      ...
      >
        ...
        <span class="folders__item-text">Черновики</span>
      </li>
      <li
        class="folders__item"
        :class="{
      ...
      >
        ...
        <span class="folders__item-text">Архив</span>
      </li>
      <li
        class="folders__item"
        :class="{
      ...
      >
        ...
        <span class="folders__item-text">Спам</span>
      </li>
      <li
        class="folders__item"
        :class="{
      ...
      >
        ...
        <span class="folders__item-text">Корзина</span>
      </li>
    </ul>
...
.sidebar__change-theme svg {
  margin-right: 8px;
}
.sidebar_mobile-full .change-theme {
  display: flex;
}
