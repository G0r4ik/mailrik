<template>
  <aside class="sidebar sidebar_dekstop">
    <button class="sidebar__write-message">
      ...
      <div class="sidebar__write-message-text">{{ $t('writeLetter') }}</div>
    </button>
    <div class="sidebar__burger" @click="showFullSidebar">
      <svg
      ...
      <span class="sidebar__burger-text">{{ $t('hide') }}</span>
    </div>
      ...
      <li
        ...
        :class="{
          folders__item_active:
            this.$store.getters.currentFolder === 'Входящие',
        }"
        @click="serCurrentFolder('Входящие')"
      >
        <svg
          width="20"
          height="20"
        ...
        <span class="folders__item-text">{{ $t('sidebarIncoming') }}</span>
      </li>
      <li
        class="folders__item"
        :class="{
          folders__item_active: this.$store.getters.currentFolder === 'Важное',
        }"
        @click="serCurrentFolder('Важное')"
      >
        <svg
          width="20"
          height="20"
        ...
        <span class="folders__item-text">{{ $t('sidebarImportant') }}</span>
      </li>
      <li
        class="folders__item"
        :class="{
          folders__item_active:
            this.$store.getters.currentFolder === 'Отправленные',
        }"
        @click="serCurrentFolder('Отправленные')"
      >
        <svg
          width="20"
          height="20"
        ...
        <span class="folders__item-text">{{ $t('sidebarSent') }}</span>
      </li>
      <li
        class="folders__item"
        :class="{
          folders__item_active:
            this.$store.getters.currentFolder === 'Черновики',
        }"
        @click="serCurrentFolder('Черновики')"
      >
        <svg
          width="20"
          height="20"
        ...
        <span class="folders__item-text">{{ $t('sidebarDrafts') }}</span>
      </li>
      <li
        class="folders__item"
        :class="{
          folders__item_active: this.$store.getters.currentFolder === 'Архив',
        }"
        @click="serCurrentFolder('Архив')"
      >
        <svg
          width="20"
          height="20"
        ...
        <span class="folders__item-text">{{ $t('sidebarArchive') }}</span>
      </li>
      <li
        class="folders__item"
        :class="{
          folders__item_active: this.$store.getters.currentFolder === 'Спам',
        }"
        @click="serCurrentFolder('Спам')"
      >
        <svg
          width="20"
          height="20"
        ...
        <span class="folders__item-text">{{ $t('sidebarSpam') }}</span>
      </li>
      <li
        class="folders__item"
        :class="{
          folders__item_active: this.$store.getters.currentFolder === 'Корзина',
        }"
        @click="serCurrentFolder('Корзина')"
      >
        <svg
          width="20"
          height="20"
        ...
        <span class="folders__item-text">{{ $t('sidebarBasket') }}</span>
      </li>
    </ul>
    ...
    <div class="sidebar__users-folder user-folder">
      <div
        ...
        :class="{
          folders__item_active: this.$store.getters.currentFolder === folder,
        }"
      >
    ...
    <button class="sidebar__settings" @click="isOpenSettings = true">
      <svg
        width="16"
        height="16"
        viewBox="0 0 16 16"
...
export default {
  components: { AppSettings, ChangeTheme },
...
.sidebar__write-message {
  height: 36px;
  border: 1px solid rgb(0 16 61 / 0.12);
  border-radius: 8px;
  width: 100%;
  display: flex;
  align-items: center;
