<template>
  <button class="sidebar__change-theme change-theme" @click="toggleTheme">
    <svg
      width="20"
      height="20"
      viewBox="0 0 20 20"
    ...
    <span class="change-theme-text">
      Тема: {{ userTheme === 'light-theme' ? 'светлая' : 'темная' }}
    </span>
  </button>
</template>
<script>
